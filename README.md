...
[👉 一键查看模板](https://cdn.gh-proxy.org/https://gist.github.com/SHICHUNHUI88/099059cfce913ef7b80496fbf4241324/raw/us_la.yaml)
...
[👉 一键查看模板](https://cdn.gh-proxy.org/https://gist.github.com/SHICHUNHUI88/ea81e07938efe1b2e892db7a9bee872e/raw/singbox-v1.12-config.json)
...
### Loy_GeoSite:[域名-mrs 规则集目录](https://github.com/SHICHUNHUI88/vps-net-optimize/tree/main/geo/geosite)
```
https://cdn.jsdelivr.net/gh/SHICHUNHUI88/vps-net-optimize@main/geo/geosite
```

### Loy_GeoIP:[IP-mrs 规则集目录](https://github.com/SHICHUNHUI88/vps-net-optimize/tree/main/geo/geoip)
```
...
### Loy-GeoSite:[SRS 目录](https://github.com/SHICHUNHUI88/vps-net-optimize/tree/main/singbox/Loy-geosite)
```
https://cdn.jsdelivr.net/gh/SHICHUNHUI88/vps-net-optimize@main/singbox/Loy-geosite
```

### Loy-GeoIP:[SRS 目录](https://github.com/SHICHUNHUI88/vps-net-optimize/tree/main/singbox/Loy-geoip)
```
...
### GeoSite:[SRS 目录](https://github.com/SHICHUNHUI88/vps-net-optimize/tree/main/singbox/geosite)
```
https://cdn.jsdelivr.net/gh/SHICHUNHUI88/vps-net-optimize@main/singbox/geosite
```

### GeoIP:[SRS 目录](https://github.com/SHICHUNHUI88/vps-net-optimize/tree/main/singbox/geoip)
```
